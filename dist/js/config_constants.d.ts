...
export declare enum OnfidoTheme {
    LIGHT = "LIGHT",
    DARK = "DARK",
    AUTOMATIC = "AUTOMATIC"
}
export type OnfidoFaceCapture = OnfidoFaceSelfieCapture | OnfidoFaceVideoCapture | OnfidoFaceMotionCapture;
...
export declare enum OnfidoCountryCode {
    ABW = "ABW",
    AFG = "AFG",
    AGO = "AGO",
    AIA = "AIA",
...
export declare enum OnfidoAlpha2CountryCode {
    ABW = "AW",
    AFG = "AF",
    AGO = "AO",
    AIA = "AI",
